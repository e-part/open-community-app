...
function CountDownObject() {
	...
	function TimerEnd(){
		...
		CanvasContext.font = 60*param.elementSize + "px almoni-dl";
		CanvasContext.textAlign = "center";
		CanvasContext.fillText("הדיון סגור", Canvas.width/2, 84.5*param.elementSize);
	}
	...
	function DrawText(){
		CanvasContext.fillStyle = textC;
		CanvasContext.font = 36*param.elementSize + "px almoni-dl";
		CanvasContext.textAlign = "center";

		if(num == 1){
			CanvasContext.fillText(secondsText, param.sec1Position + 80*0.5*param.elementSize, 150*param.elementSize);
		}else{
			CanvasContext.fillText(secondsText, param.sec1Position - 80*0.05*param.elementSize, 150*param.elementSize);
		}
		if(num == 3){
			CanvasContext.fillText(minutesText, param.min1Position + 80*0.5*param.elementSize, 150*param.elementSize);
		}else if(num > 3){
			CanvasContext.fillText(minutesText, param.min1Position - 80*0.05*param.elementSize, 150*param.elementSize);
		}
		if(num == 5){
			CanvasContext.fillText(hoursText, param.hour1Position + 80*0.5*param.elementSize, 150*param.elementSize);
		}else if(num > 5){
			CanvasContext.fillText(hoursText, param.hour1Position - 80*0.05*param.elementSize, 150*param.elementSize);
		}
		if(num == 7){
			CanvasContext.fillText(daysText, param.day1Position + 80*0.5*param.elementSize, 150*param.elementSize);
		}else if(num == 8){
			CanvasContext.fillText(daysText, param.day1Position - 80*0.05*param.elementSize, 150*param.elementSize);
		}else{
			CanvasContext.fillText("ימים", param.day1Position - 80*0.6*param.elementSize, 150*param.elementSize);
		}
	}
	...
	this.Start = function(el){
		...
		daysText = this.DAYS_TEXT,
    hoursText = this.HOURS_TEXT,
    minutesText = this.MINUTES_TEXT,
    secondsText = this.SECONDS_TEXT;

		// add canvases to Html
		el.append('<img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" id="ResizingImage' + this.CANVAS_NAME + '" width="100%" height="1"></img>');
		el.append('<canvas id="' + this.CANVAS_NAME + '"></canvas>');

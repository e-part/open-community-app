(function () {
  ...
  angular
    ...
    .config(function ($stateProvider) {
      $stateProvider
        .state('app.admin.browser', {
          abstract: true,
          url: '/browser',
          templateUrl: 'modules/browser/views/main.html'
        })
        .state('app.admin.browser.models', {
          url: '',
        ...
        .state('app.admin.browser.models.info', {
          url: '/:modelName/info',
        ...
        .state('app.admin.browser.models.items', {
          url: '/:modelName',
        ...
        .state('app.admin.browser.models.items.view', {
          url: '/:modelId/view',
        ...
        .state('app.admin.browser.models.items.edit', {
          url: '/:modelId/edit',
            ...
            function ($state, MetaService, model, item, itemFields) {
              ...
              this.submit = function () {
                MetaService.upsert(model.name, this.item).then(function () {
                  $state.go('app.admin.browser.models.items', {modelName: model.name}, {reload: true});
                });
              };
            }
          ],
        ...
        .state('app.admin.browser.models.items.add', {
          url: '/add',
        ...
        .state('app.admin.browser.models.items.delete', {
          url: '/:modelId/delete',
          template: '',
          controller: [
            '$state',
